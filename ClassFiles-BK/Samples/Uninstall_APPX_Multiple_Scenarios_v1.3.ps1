...
# Scenario #2:  Being explicit for the APPXPackage name(s)
    # Advantages?:
    # Disadvantages?:
$AppxPkgs= "Microsoft.MicrosoftSolitaireCollection","MicrosoftWindows.Client.WebExperience","Microsoft.GetHelp","Microsoft.WindowsSoundRecorder","Microsoft.Getstarted","Microsoft.phone","Microsoft.Microsoft3DViewer","Microsoft.MicrosoftOfficeHub","Microsoft.People","Microsoft.SkypeApp","microsoft.windowscommunicationsapps","Microsoft.WindowsFeedbackHub","Microsoft.WindowsSoundRecorder","Microsoft.Xbox.TCUI","Microsoft.XboxApp","Microsoft.XboxGameOverlay","Microsoft.XboxGamingOverlay","Microsoft.XboxIdentityProvider","Microsoft.XboxSpeechToTextOverlay","Microsoft.YourPhone","Microsoft.ZuneMusic","Microsoft.Advertising.Xaml"
foreach($AppxPkg in $AppxPkgs) {
    $AppxPkg
    Get-AppxPackage $AppxPkg #|Remove-AppxPackage -Verbose
    #Get-AppxPackage $AppxPkg #|Remove-AppxPackage -AllUsers -Verbose
...
Get-AppxPackage | Where-Object {$_.Isframework -eq $false -and $_.NonRemovable -eq $false } | Select-Object -Property Name,NonRemoveable # Not working 
...
Get-AppxPackage | Where-Object {$_.Isframework -eq $false -and $_.NonRemoveable -ne $true } | Select-Object -Property Name,IsFramework,NonRemoveable
